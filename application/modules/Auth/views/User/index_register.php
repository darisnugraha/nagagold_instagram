                            ...
                            <div class="box-authentication">
                                ...
                                <?= form_error('pass_key', '<div class="alert alert-danger" role="alert">','</div>'); ?>
                                    ...
                                    <label>Nama Lengkap <span class="required"> * </span></label>
                                        ...
                                        <input type="hidden" value="<?= $this->session->userdata('kode_customer_lama'); ?>" name="kode_customer"  class="form-control" >
                                        <input type="text" value="<?= $this->session->userdata('nama_customer_lama'); ?>" required name="nama_customer" required placeholder="Masukan Nama" class="form-control" >
                                    </div>
                                    <div class="form-group">
                                    <label>No Hp <span class="required"> * </span></label>
                                        <input type="number"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  value="<?= $this->session->userdata('no_hp_lama'); ?>" required name="no_hp" required placeholder="Masukan No Hp" class="form-control" >
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h3>&nbsp;</h3>
                                ...
                                <p>Jika Anda lupa password masukan email.</p> -->
                                    <div class="form-group">
                                    <input type="hidden" id="kecamatan_lama" value="<?= explode('-',$this->session->userdata('kecamatan_lama'))[0]  ?>">
                                    ...
                                    <div id="pesaneror" class="form-group">
                                        <label class="control-label">Masukan Password <span class="required"> * </span></label></label>
                                        <input type="password" class="form-control" name="password" id="pass1"  placeholder="Masukan Password"  aria-describedby="helpBlock2">
                                    </div>
                                    <div id="pesaneror2" class="form-group">
                                        <label class="control-label">Ulangi Password <span class="required"> * </span></label>
                                        <input type="password" required id="pass2" name="retype_password" class="form-control" placeholder="Ulangi Password" name="password">
