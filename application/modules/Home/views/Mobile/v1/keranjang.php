<div class="container">
            <div class="subtitle h6" align="center">
                <div class="d-inline-block">
                    My Cart<br>
                    <p class="small text-mute">2 Items</p>
                </div>
            </div>
                    ...
                    <ul class="list-group list-group-flush mb-4">
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-2 pl-0 align-self-center">
                                    <figure class="product-image h-auto"><img src="<?= base_url('assets/images/produk/') ?>p1.png" alt="" class="vm"></figure>
                                </div>
                                <div class="col px-0">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-2 pl-0 align-self-center">
                                    <figure class="product-image h-auto"><img src="<?= base_url('assets/images/produk/') ?>c2.png" alt="" class="vm"></figure>
                                </div>
                                <div class="col px-0">
                                ...
                                <!-- <div class="col-auto align-self-center">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control w-32" placeholder="" value="1">
                                    </div>
                                </div> -->
                            </div>
                        </li>
