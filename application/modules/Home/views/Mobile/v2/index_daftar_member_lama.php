            ...
            <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
                ...
                <div class="register-form mt-5 px-4">
                    <form id="form-register" action="<?= base_url('simpanregisteruser') ?>" method="POST">
                        <div class="form-group text-left mb-4"><span>Nama Lengkap</span>
                            ...
                            <input class="form-control nama_customer"
                                value="<?= $this->session->userdata('kode_customer_lama'); ?>" required
                                name="kode_customer" type="hidden" placeholder="Masukan Nama Lengkap">
                            <input type="text" value="<?= $this->session->userdata('nama_customer_lama'); ?>" required
                                name="nama_customer" placeholder="Masukan Nama" class="form-control">
                        </div>
                ...
                for ($i = 0; $i < $count; $i++) : ?>
                        ...
                        <div class="form-group text-left mb-4"><span>Pilih Kecamatan</span>
                            <label for="password"><i class="lni lni-map-marker"></i></label>
                            <input type="hidden" id="kecamatan_lama" required
                        ...
                        <div id="pesaneror" class="form-group text-left mb-4">
                            ...
                            <input type="password" class="form-control" id="pass1" name="password"
                                placeholder="Masukan Password" required aria-describedby="helpBlock2">
                        </div>
                        <div id="pesaneror2" class="form-group text-left mb-4">
                            <span>Ulangi Password</span>
                            <label for="password"><i class="lni lni-lock"></i></label>
                            <input type="password" required id="pass2" class="form-control" required
                                placeholder="Ulangi Password" name="retype_password">
                        ...
                        <button class="btn btn-login btn-lg w-100" onclick="validasiformdaftar();"
                            type="button"><?= $nama_button ?></button>
                    </form>
                </div>
                <!-- Login Meta-->
                <div class="login-meta-data"><a onclick="$('.loaderform').show();"
                        class="text-white forgot-password d-block mt-3 mb-1"
                        href="<?= base_url('forgetpassword') ?>">Forgot Password?</a>
                    <p class="text-white mb-0">Sudah Punya Akun ?<a onclick="$('.loaderform').show();"
                            class="text-white ml-2" href="<?= base_url('login') ?>">Klik Disini</a></p>
                    <p class="text-white mb-0">Aktivasi Member Lama ?<a onclick="$('.loaderform').show();"
                            class="text-white ml-2" href="<?= base_url('formaktifasimemberlama') ?>">Klik Disini</a></p>
                </div>
            </div>
        </div>
    </div>
