        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
            ...
            <div class="otp-verify-form mt-5 px-4">
              <form action="<?= base_url('verifikasi-otp') ?>" method="POST" class="digit-group" data-group-name="digits" data-autosubmit="false" autocomplete="off">
            ...
            <div class="login-meta-data px-4">
              <p class="mt-3 mb-0">Don't received the OTP? <div id="tampilkan" class="text-white"></div> <span class="otp-sec ml-1 text-white" style="display: none;" id="resendOTP">
                  <a class="text-white ml-2" href="<?= base_url('resend-otp/' . encrypt_url($this->session->userdata('email'))) ?>">Kirim ulang</a></span></p>
            </div>
          </div>
        </div>
      </div>
