...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/404/normalize.min.css">
    <link rel='stylesheet' href='<?= base_url() ?>assets/404/bootstrap.min.css'>
    ...
    <main>
        <div class="container">
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                ...
                <div class="col-md-6 align-self-center">
                    <h1>403</h1>
                    <h2>Koneksi Internet Anda Terputus.</h2>
                    <p>Halaman yang anda minta tidak bisa terload secara otomatis, dikarenakan koneksi internet anda mati, periksa kembali koneksi internet anda
                    </p>
                    <a class="btn green" href="<?= base_url() ?>">HOME</a>
                </div>
            </div>
        </div>
    </main>
    <!-- partial -->
    <script src='<?= base_url() ?>assets/404/gsap.min.js'></script>
    <script src="<?= base_url() ?>assets/404/script.js"></script>
