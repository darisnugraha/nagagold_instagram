                ...
                <form action="<?= base_url('simpan-kategori') ?>" method="POST">
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <input type="text" autocomplete="off" name="kode_kategori" required onkeypress="return event.keyCode != 13;" class="input w-full border mt-2 flex-1" placeholder="Masukan Kode Kategori">
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <label>Nama Kategori</label>
                            <input type="text" autocomplete="off" name="nama_kategori" required onkeypress="return event.keyCode != 13;" class="input w-full border mt-2 flex-1" placeholder="Masukan Nama Kategori">
                        </div>
