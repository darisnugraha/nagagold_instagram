        ...
        <div class="preview">
            <div class="modal" id="editkategori<?= $row->kode_kategori  ?>">
                <div class="modal__content">
                    ...
                    <form action="<?= base_url('edit-kategori') ?>" method="POST">
                        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                            <div class="col-span-12 sm:col-span-6">
                                <label>Kode Kategori</label>
                                <input type="hidden" value="<?= $row->kode_kategori ?>" name="kode_kategori" class="input w-full border mt-2 flex-1" placeholder="Masukan Kode Kategori">
                                <input type="text" autocomplete="off" value="<?= $row->kode_kategori ?>" disabled class="input w-full border mt-2 flex-1" placeholder="Masukan Kode Kategori">
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <label>Nama Kategori</label>
                                <input type="text" autocomplete="off" required onkeypress="return event.keyCode != 13;" value="<?= $row->nama_kategori ?>" name="nama_kategori" class="input w-full border mt-2 flex-1" placeholder="Masukan Nama Kategori">
                            </div>
                            <?php
                            $icon = array(
                                'aksesoris' => "aksesoris",
