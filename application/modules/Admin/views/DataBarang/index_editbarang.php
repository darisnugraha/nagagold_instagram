                                ...
                                <div>
                                    ...
                                    <select class="input w-full border mt-2 select2 kategori" name="kode_kategori" required style="width: 100%">
                                        ...
                                        <?php foreach($DataKategori->data  as $kd ): ?>
                                            <option value="<?= $kd->kode_kategori ?>"> <?= $kd->nama_kategori ?> </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="intro-y col-span-3 lg:col-span-3 imageshow<?= $data_gambar[$i]->kode_gambar ?>">
                                    <div class="mt-3">
                                        <div>
                                            ...
                                            <!-- <input id="file-input1" name="photo<?= $i ?>" onchange="document.getElementById('<?= $data_gambar[$i]->kode_gambar ?>').src = window.URL.createObjectURL(this.files[0])" type="file" /> -->
