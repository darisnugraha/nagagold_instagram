<div class="p-5" id="header-footer-modal">
    <div class="preview">
        <div class="modal" id="tambahkeompok">
            <div class="modal__content">
                ...
                <form action="<?= base_url('simpan-kelompok') ?>" method="POST">
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <input type="text" required onkeypress="return event.keyCode != 13;" name="nama_kelompok" class="input w-full border mt-2 flex-1" placeholder="Masukan Nama Kelompok">
                        </div>
                    </div>
