        ...
        <form class="faq-search-form" action="#" method="">
            ...
            <div class="card mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <small class="card-title">#21830183091230SDAP9</small><br>
                    <div class="row">
                        <div class="col-3"> 
                        ...
                        <div class="col-5"><small> 30-Oktober-2020 <br> Samsul Arifin</small> </div>
                        <div class="col-4" align="center"> <a href="<?= base_url('detail-penjualan-admin') ?>" class="btn btn-success w-100"> Detail </a> </div>
                    </div>
                    </div>
                </div>
