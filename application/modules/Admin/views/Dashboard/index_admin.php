            ...
            <div class="col-span-12 mt-8">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                        <a href="<?= base_url('wp-lihat-penjualan') ?>">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-bold leading-8 mt-6">
                                        <?= $BarangTerjual->data[0]->penjualan == 0 ?  'Belum Ada Penjualan' : number_format($BarangTerjual->data[0]->penjualan )?>
                                    </div>
                                    <div class="text-base text-gray-600 mt-1">
                                        <?= $BarangTerjual->data[0]->penjualan == 0 ?  'Hari Ini' : "Barang Terjual Hari Ini" ?>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                        <a href="<?= base_url('wp-validasi-penjualan') ?>">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                    ...
                                    <div class="text-3xl font-bold leading-8 mt-6">
                                        <?= $OrderanBaru->data[0]->penjualan==0 ? "Belum Ada Orderan" : $OrderanBaru->data[0]->penjualan ?>
                                    </div>
                                    <div class="text-base text-gray-600 mt-1">
                                        <?= $OrderanBaru->data[0]->penjualan==0 ? "Hari Ini" : "Orderan Baru" ?></div>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                    <a href="<?= base_url('wp-barang-online') ?>">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                <div class="flex">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">
                                    <?= number_format($TotalBarangOnline->data[0]->barang_online) ?></div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">
                                    <?= $DataPengunjung->data[0]->pengunjung ==0 ? 'Belum Ada Pengunjung' : number_format($DataPengunjung->data[0]->pengunjung) ?>
                                </div>
                                <div class="text-base text-gray-600 mt-1">
                                    <?= $DataPengunjung->data[0]->pengunjung ==0 ? 'Hari Ini' : "Pengunjung Hari Ini"?>
                                </div>
                            </div>
                        </div>
                    </div>
