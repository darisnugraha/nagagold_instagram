<div class="p-5" id="header-footer-modal">
    <div class="preview">
        <div class="modal" id="tambahnorek">
            <div class="modal__content">
                ...
                <form action="<?= base_url('simpan-norek') ?>" method="POST">
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        <div class="col-span-12 sm:col-span-12">
                            <label>Nama Bank</label>
                            <input type="text" autocomplete="off" onkeypress="return HurufNoEnter(event)" name="nama_bank" class="input w-full border mt-2 flex-1" placeholder="Masukan Bank">
                        </div>
                        <div class="col-span-12 sm:col-span-12">
                            <label>No Rekening</label>
                            <input type="text" autocomplete="off" onkeypress="return NumberNoEnter(event)" name="no_rekening" class="input w-full border mt-2 flex-1" placeholder="Masukan No Rekening Pemilik">
                        </div>
                        <div class="col-span-12 sm:col-span-12">
                            <label>Atas Nama</label>
                            <input type="text" autocomplete="off" name="atas_nama" onkeypress="return HurufNoEnter(event)" class="input w-full border mt-2 flex-1" placeholder="Masukan Atas Nama Pemilik Rekening">
                        </div>
