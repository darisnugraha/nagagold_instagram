...
<div class="p-5" id="header-footer-modal">
    <div class="preview">
        <div class="modal" id="edit_data_toko">
            <div class="modal__content">
                ...
                <form action="<?= base_url('simpan-edit-toko') ?>" method="POST">
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        <div class="col-span-12 sm:col-span-12">
                            <label>Kode Toko</label>
                            <input type="text" readonly onkeypress="return event.keyCode != 13;" name="kode_toko" class="input w-full border mt-2 flex-1 kode_toko" placeholder="Masukan Kode Toko">
                        </div>
                        <div class="col-span-12 sm:col-span-12">
                            <label>Nama Toko</label>
                            <input type="text" onkeypress="return HurufNoEnter(event)" name="nama_toko" class="input w-full border mt-2 flex-1 nama_toko_edit" placeholder="Masukan Nama Toko">
                        </div>
                        <div class="col-span-12 sm:col-span-12">
                            <div class="mt-2">
                                <label>Pilih Provinsi</label>
                                <select autocomplete="off" required name="provinsi" class="select2 w-full provinsikuedit">
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            <div class="mt-2">
                                ...
                                <select required autocomplete="off" required name="kota" class="select2 w-full kotakuedit">
                                    <option value="">Pilih Kota</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-12">
                            <div class="mt-2">
                                <label>Pilih Keccamatan</label>
                                <select required autocomplete="off" name="kecamatan" class="select2 w-full kecamatankuedit">
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <input type="text" name="kode_pos" onkeypress="return NumberNoEnter(event)" class="input w-full border mt-2 flex-1 kode_posedit" placeholder="Masukan Kode Pos">
                        </div>
                        <div class="col-span-12 sm:col-span-12">
                            <label>Alamat Lengkap</label>
                            <input type="text" name="alamat" onkeypress="return event.keyCode != 13;" class="input w-full border mt-2 flex-1 alamat_edit" placeholder="Masukan Alamat Lengkap">
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.provinsikuedit').on('change', function() {
            var id = $(this).val();
            console.log(id);
            ...
            $.ajax({
                ...
                complete: function(respons) {
                    ...
                    $('.kotakuedit').html("<option value=''>Pilih Kota</option>");
        ...
        $('.kotakuedit').on('change', function() {
            ...
            $.ajax({
                ...
                complete: function(respons) {
                    var feedback = respons.responseJSON;
                    $('.kecamatankuedit').html("<option value=''>Pilih Kecamatan</option>");
                    $.each(feedback.data, function(index, element) {
                        $('.kecamatankuedit').append(`
