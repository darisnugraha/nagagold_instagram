...
$pdf->AddPage('P', 'A4');
$pdf->SetTitle('Laporan Tambah Barang');
...
<font size="10" face="Times New Roman">
    <table border="0">
        <tr>
            ...
            <td align="center" width="36.5%"><b><font size="14px">Laporan ' . ucfirst($type) . ' Tambah Barang </font></b> <br><br> Periode <br> ' . $tgl_awal  . ' s/d ' . $tgl_akhir . '<br></td>
            <td align="right"></td>
        </tr>
        <tr align="right">
            <td width="32.5%" > </td>
...
<tr bgcolor="#d9d9d9">
    ...
    <th width="20%" style="border-top: 1px solid black; border-bottom: 1px solid black;" align="center">Berat Asli</th>
</tr>
';
$i=1;
$berat=0;
$beratasli=0;
foreach ($LaporanTambahBarang->data as $row) {
    $berat += $row->berat;
    ...
    $html .= '
        ...
        <td width="20%" align="center">'.$row->berat_asli.'</td>
        </tr>
    ';
}
$html .= '
