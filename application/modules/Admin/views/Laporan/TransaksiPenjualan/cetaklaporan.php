...
$html = '
			...
			<table border="0">
				<tr>
					...
					<td align="center" width="36.5%"><b><font size="15px"><br>Laporan Transaksi Penjualan</font></b> <br><br>Periode<br>' . $tgl_awal . ' s/d ' . $tgl_akhir . '<br> </td>
					<td width="30%"></td>
				</tr>
				<tr align="right">
					<td width="32.5%" ></td>
...
foreach ($DataLaporanBarang->data as $row) {
	...
	foreach ($row->detail_barang as $barang) {
		...
		$grandsub += $barang->harga + $barang->ongkos;
