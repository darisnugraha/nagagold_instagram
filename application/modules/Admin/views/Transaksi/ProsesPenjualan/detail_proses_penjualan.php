        ...
        foreach ($DetailTransaksi->data as $row) : ?>
            ...
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">
                    Detail Proses Penjualan
                </h2>
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">

                    <a class="button text-white bg-theme-1 shadow-md mr-2" target="_blank" href="<?= base_url('printinvoiceproses/' . $row->id_trx . '') ?>">Print</a>
            ...
            <div class="intro-y box overflow-hidden mt-5">
                            ...
                            <tbody>
                                ...
                                <?php endforeach; ?>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <!-- <tr>
                                            <td nowrap>Barang Diantar Dengan Kurir : <br>
                ...
                <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row">
                    ...
                    <?php if ($row->type_trx == "AMBIL") : ?>
                        <input type="hidden" value="-" name="no_resi">
                        Barang di ambil di toko : <br>
                        <?php foreach ($row->toko  as $toko) : ?>
                                            <?= $toko->nama_toko ?> <br>
                                            <?= $toko->alamat_lengkap ?><br>
                                            <?= $toko->nama_kecamatan ?>
                    ...
                    <input type="text" required placeholder="Masukan No Resi" value="" name="no_resi" class="input w-full border mt-2 flex-1">
