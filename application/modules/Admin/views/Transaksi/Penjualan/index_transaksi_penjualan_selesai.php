<div class="content">
    ...
    <div class="intro-y datatable-wrapper box p-5 mt-5">
        <form action="<?= base_url('cari-detail-transaksi') ?>" method="POST">
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                ...
                <div class="col-span-4">
                    ...
                    <input type="text" name="kode_customer" class=" input w-full border " placeholder=" Masukan Nomer Transaksi">
                </div>
                <div class="col-span-4">
                <div class="col-span-4">
                    <label>&nbsp;</label>
                    ...
                    <tr>
                        ...
                        <td class="border-b-2 text-center whitespace-no-wrap">
                            <div class="flex sm:justify-center items-center">
                                <a class="flex items-center mr-3 pointer" href="<?= base_url('detail-lihat-penjualan/' . $row->id_trx . '') ?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Lihat </a>
                            </div>
