<div class="content">
    ...
    <div class="intro-y datatable-wrapper box p-5 mt-5">
        <form action="<?= base_url('cari-validasi-penjualan') ?>" method="POST">
                    ...
                    <tr>
                        ...
                        <td class="border-b-2 text-center whitespace-no-wrap">
                            <div class="flex sm:justify-center items-center">
                                <a class="flex items-center mr-3 pointer" href="<?= base_url('detail-validasi-penjualan/' . $row->id_trx . '') ?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Lihat </a>
                            </div>
