                ...
                <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row">
                    <div class="text-center sm:text-left mt-10 sm:mt-0">
                        ...
                        <?php foreach ($row->bukti_bayar  as $buktitf) : ?>
                            ...
                            <!-- <a href="<?= base_url('assets/images/NsiPic/buktitransfer/' . $buktitf->bukti_transfer) ?>" target="_blank">
                                <img width="100px" height="100px" src="<?= base_url('assets/images/NsiPic/buktitransfer/' . $buktitf->bukti_transfer) ?>"></a> -->
                        <?php endforeach; ?>
                    </div>
