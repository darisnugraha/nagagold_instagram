        ...
        $html .= '
			...
			<table border="0">
				<tr>
					...
					<td width="32.5%" width="30%" align="right">
                    <span>
                        <span color="#1C3FAA">'.$row->nama_customer.'</span>
                        <br>'.$row->email.'
                        <br>'.$row->no_hp.'
                        <br>';
                    if ($row->type_trx=="AMBIL") {
                        foreach ($row->alamat  as $alamat) {
                            if ($alamat->status_default==1) {
                                $html .= $alamat->alamat_lengkap.', '.$alamat->nama_kecamatan.'<br>'.$alamat->nama_kota.','.$alamat->nama_provinsi;
                            }
                        }
                    }else{
            ...
            <table  cellspacing="0"  border="0" cellpadding="2" rules="rows">
              ...
              foreach ($row->detail_barang  as $detailbarang) {
                ...
                $html .= '
                    ...
                    <td style="border-bottom: 0.5px solid black;" align="center">'.number_format($total_harga).'</td>
                </tr>';
              }
              $html .='<!-- <tr>
                ...
                <tr>
                    ...
                    <td style="border-bottom: 0.5px solid black;" align="center">'.number_format($grandtotal).' </td>
                </tr>';
                $html .='<tr>
                    <td colspan="4"></td>
                    <td align="right"></td>
