<div class="p-5" id="header-footer-modal">
    <div class="preview">
        <div class="modal" id="ambilstockhadiah">
            <div class="modal__content">
                ...
                <form action="<?= base_url('simpan-ambil-stock-hadiah') ?>" method="POST">
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        <div class="col-span-12 sm:col-span-12">
                            <label>Pilih Kode Hadiah</label>
                            <select class="select2 mr-2 w-full" name="kode_hadiah" id="kode_group">
