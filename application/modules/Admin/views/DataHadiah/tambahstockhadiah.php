<div class="p-5" id="header-footer-modal">
    <div class="preview">
        <div class="modal" id="tambahstockhadiah">
            <div class="modal__content">
                ...
                <form action="<?= base_url('simpan-tambah-stock-hadiah') ?>" method="POST">
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        <div class="col-span-12 sm:col-span-12">
                            <label>Pilih Kode Hadiah</label>
                            <select class="select2 mr-2 w-full" name="kode_hadiah" id="kode_group_ambil">
                            <option value="">Pilih Kode Hadiah</option>
                            <?php foreach($DataHadiah->data  as $row ): ?>
                                <option value="<?= $row->kode_hadiah ?>"> <?= $row->kode_hadiah ?> - <?= $row->nama_hadiah ?>  </option>
                            <?php endforeach; ?>
                        </select>
                            <!-- <input type="text" required onkeypress="return event.keyCode != 13;" name="kode_hadiah" class="input w-full border mt-2 flex-1" placeholder="Masukan Kode Hadiah"> -->
                        </div>
                        <!-- <div class="col-span-12 sm:col-span-12">
                            <label>Nama Hadiah</label>
                            <input type="text" required onkeypress="return event.keyCode != 13;" name="nama_hadiah" class="input w-full border mt-2 flex-1" placeholder="Masukan Nama Hadiah">
                        </div> -->
                        <!-- <div class="col-span-12 sm:col-span-12">
                            <label>Stock</label>
                            <input type="text" required onkeypress="return NumberNoEnter(event)" name="stock" class="input w-full border mt-2 flex-1" placeholder="Masukan Stock Hadiah">
                        </div> -->
                        <div class="col-span-12 sm:col-span-12">
                            <label>Qty</label>
                            <input type="text" required onkeypress="return NumberNoEnter(event)" name="qty_tambah" class="input w-full border mt-2 flex-1" placeholder="Masukan Qty Stock Hadiah">
                        </div>
